...
#include <string.h>
        ...
        const char* networkName = "TELLO-FE2EE8";
        ...
        //wifi event handler
        void WifiConnection::WiFiEvent(WiFiEvent_t event, system_event_info_t info){
                switch(event) {
        ...
        void WifiConnection::sendCommand(string message)  
        {
